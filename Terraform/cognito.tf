...
resource "aws_cognito_user_pool_client" "client" {
  ...
  callback_urls                        = ["http://localhost"] # var.callback_urls
  logout_urls                          = ["http://localhost"] # var.logout_urls
...
resource "aws_cognito_identity_provider" "google" {
  ...
  provider_details = {
    client_id                     = "fidopjgmpaeqrfq" # var.client_id
    client_secret                 = "opdjgajagkpaj"   # var.client_secret
